    ...
    <section class="news">
        ...
        <div class="row mt-4">
            <div class="col-md-8 mx-auto bg-light rounded p-4">
                <h5 class="text-center font-weight-bold">เกมยิง</h5>
                
                <form action="shootingdetails.php" method="POST" class="p-3" style="position: relative;">
                    ...
                    <?php
                        $stml = $conn->query("SELECT * FROM shooting_game"); 
                        $stml->execute();

                        $shooting_game = $stml->fetchAll();
                        foreach ($shooting_game as $user) {
                    ?>
                        <div class="news-box">
