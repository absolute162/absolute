<?php 
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "SELECT * FROM gamenews WHERE fname = :fname";
        $stmt = $conn->prepare($sql);
        $stmt->execute(['fname' => $fName]);
        $row = $stmt->fetch();
    } else {
        header("location: gamenews.php");
        exit();
    }
...
<header class="header5">
    ...
    <section class="news">
        ...
        <div class="row mt-4">
            <div class="col-md-8 mx-auto bg-light rounded p-4">
                <h5 class="text-center font-weight-bold">ข้อมูลข่าวสาร</h5>
                
                <form action="gamenewsdetails.php" method="POST" class="p-3" style="position: relative;">
    ...
    <script src="js/gamenews.js"></script>
</body>
</html>