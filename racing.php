    ...
    <section class="news">
        ...
        <div class="row mt-4">
            <div class="col-md-8 mx-auto bg-light rounded p-4">
                <h5 class="text-center font-weight-bold">Racing</h5>
                
                <form action="racingdetails.php" method="POST" class="p-3" style="position: relative;">
                    ...
                    <?php
                        $stml = $conn->query("SELECT * FROM racing"); 
                        $stml->execute();

                        $racing = $stml->fetchAll();
                        foreach ($racing as $user) {
                    ?>
                        <div class="news-box">
